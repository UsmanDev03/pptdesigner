<footer class="bg-black">
    <div class="logo flex justify-center items-center">
        <img src="{{ asset('imgs/PPTDesigner logo white-01.png') }}" alt="" class=" w-40 pt-10">
    </div>
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <p class="flex items-center justify-center font-normal text-lg pt-6 text-center md:text-center text-white">
                You can improve the quality of your presentations with the good designs, and this can be done by searching for the effective powerpoint presentation design services such as PPTDesigner.ae
            </p>
        </div>
        <div class="col-md-3"></div>
    </div>
    <div class="flex items-center justify-center gap-x-5 mt-4 pb-4">
    ...
    <ul class="flex justify-center items-center hidden lg:w-auto lg:space-x-12 lg:items-center lg:flex ">
        <li><a href="" class="text-md text-white hover:text-gray-400 dark:text-white dark:hover:text-gray-400">About Us</a></li>
        <li><a href="" class="text-md text-gray-700 hover:text-gray-400 dark:text-white dark:hover:text-gray-400">FAQs</a></li>
        <li><a href="" class="text-md text-gray-700 hover:text-gray-400 dark:text-white dark:hover:text-gray-400">Terms & Conditions</a></li>
        <li><a href="" class="text-md text-gray-700 hover:text-gray-400 dark:text-white dark:hover:text-gray-400">Privacy Policy </a></li>
        <li><a href="" class="text-md text-gray-700 hover:text-gray-400 dark:text-white dark:hover:text-gray-400">Contact us</a></li>
    </ul>
    <ul class="mob-nav  justify-center items-center text-center md:hidden lg:hidden">
        <li><a href="" class="text-md text-white hover:text-gray-400 dark:text-white dark:hover:text-gray-400">About Us</a></li>
        <li><a href="" class="text-md text-gray-700 hover:text-gray-400 dark:text-white dark:hover:text-gray-400">FAQs</a></li>
        <li><a href="" class="text-md text-gray-700 hover:text-gray-400 dark:text-white dark:hover:text-gray-400">Terms & Conditions</a></li>
        <li><a href="" class="text-md text-gray-700 hover:text-gray-400 dark:text-white dark:hover:text-gray-400">Privacy Policy </a></li>
    ...
    <p class="flex items-center justify-center font-normal text-sm text-center pt-6 text-gray-400 pb-6">© 2019 PPTDesigner.ae. All rights reserved.</p>
</footer>
